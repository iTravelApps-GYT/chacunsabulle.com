...
namespace Commic.Controllers
{
    public class IndexController : Controller
    {
        ...
        {
            //if (Request.Cookies["FirstName"] != null && Request.Cookies["Password"] != null)
            //{
        ...
        public ActionResult PertABuller(string livaddress, string sb, string sp, string duree, string deltype, string delprice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1)
        {
            try
            {
                ...
                DataColumn BFirstName = new DataColumn("BFirstName", typeof(System.String));
                DataColumn BLastname = new DataColumn("BLastname", typeof(System.String));
                DataColumn Address = new DataColumn("Address", typeof(System.String));
                DataColumn BAddress = new DataColumn("BAddress", typeof(System.String));
                DataColumn Contact = new DataColumn("Contact", typeof(System.String));
                DataColumn BContact= new DataColumn("BContact", typeof(System.String));
                ...
                DataColumn SubsType = new DataColumn("SubsType", typeof(System.String));
                DataColumn Dureetype = new DataColumn("Dureetype", typeof(System.String));
                DataColumn AdultUni = new DataColumn("AdultUni", typeof(System.String));
                DataColumn AdultGen = new DataColumn("AdultGen", typeof(System.String));
                DataColumn ChildUni = new DataColumn("ChildUni", typeof(System.String));
                DataColumn ChildGen = new DataColumn("ChildGen", typeof(System.String));
                DataColumn Offername = new DataColumn("Offername", typeof(System.String));
                DataColumn Offerprename = new DataColumn("Offerprename", typeof(System.String));
                DataColumn Offermsg = new DataColumn("Offermsg", typeof(System.String));

                //Adding columns to datatable
                dt.Columns.AddRange(new DataColumn[] { TotalAmt, ChkByMail, FirstName, Lastname, BFirstName, BLastname, Address, BAddress, Contact, BContact, VoucharCode, EmailId, DelevaryType, SubsType, Dureetype, AdultUni, AdultGen, ChildUni, ChildGen, Offername, Offerprename, Offermsg });

                dt.Rows.Add(totamt,"", fn,ln,fn1,ln1, add + ", City :" + Ville + ", Postal code : " + postcode,add1+", City : "+Ville1+", Postal Code : "+postcode1, Telephone,Telephone1,tmp,"", deltype, sb, duree,"","","","","","","");
                ...
                ////Adding columns to datatable
                //dt.Columns.AddRange(new DataColumn[] { TotalAmt, FirstName, Address, Contact, DelevaryType,SubsType,Dureetype});

                //dt.Rows.Add(totamt, fn + " " + ln, add + " City " + Ville + " Postal code : " + postcode, Telephone, deltype,SubsType,Dureetype);
                HttpContext.Session["data"] = dt;
                if (duree == "Prelevement Mensuel")
                {
                    ...
                    string datetime = DateTime.Today.AddMonths(1).ToString("dd-MM-yyyy");
                    cmd.Parameters.AddWithValue("@DueDate", datetime);
                    cmd.Parameters.AddWithValue("@liv3Add", livaddress);
                ...
                else  if (duree == "3 Mois")
                {
                    for (int k = 1; k <= 3; k++)
                    {
                        ...
                        cmd.Parameters.AddWithValue("@BillingCity", Ville1);
                        cmd.Parameters.AddWithValue("@BillingTelephone", Convert.ToInt64(Telephone1));
                        string datetime = DateTime.Today.AddMonths(k).ToString("dd-MM-yyyy");
                        cmd.Parameters.AddWithValue("@DueDate", datetime);
                        cmd.Parameters.AddWithValue("@liv3Add", livaddress);
                        //cmd.Parameters.AddWithValue("@OfferSandBy", obj.objIdenDetail.Address);
                        cmd.Parameters.AddWithValue("@SubscriptionType", "Subscription");
                ...
                if (scopeid > 0)
                {
                    ...
                    HttpContext.Session["livAdd"] = livaddress;
                    return Json("True");
        ...
        public ActionResult FormuleBSMCommon(string sb, string sp, string duree, string deltype, string delprice, string CatName, string ComicName, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, "", fn, ln, fn1, ln1, add + ", City :" + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, "", deltype, sb, duree, CatName,ComicName, "", "", "", "", "");
                ...
                ////Adding columns to datatable
                //dt.Columns.AddRange(new DataColumn[] { TotalAmt, FirstName, Address, Contact, DelevaryType });
                ...
                if (duree == "Prelevement Mensuel")
                {
                    ...
                    string datetime = DateTime.Today.AddMonths(1).ToString("dd-MM-yyyy");
                    cmd.Parameters.AddWithValue("@DueDate", datetime);
                    cmd.Parameters.AddWithValue("@liv3Add", livadd);
                    cmd.Parameters.AddWithValue("@Qtype", "Insert");
                ...
                if (scopeid > 0)
                {
                    TrasactionNumber = GetTrasactionID(scopeid);
                    HttpContext.Session["TrasactionNumber"] = TrasactionNumber;
                    HttpContext.Session["livAdd"] = livadd;
        ...
        public ActionResult FormuleMBCommon(string sb, string sp, string duree, string deltype, string delprice, string kidCatName, string kidComicName, string gender, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, "", fn, ln, fn1, ln1, add + ", City :" + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, "", deltype, sb, duree, "", "",kidCatName ,kidComicName, "", "", "");
        ...
        public ActionResult FormuleMiniNMaxi(string sb, string sp, string duree, string deltype, string delprice, string CatName, string kidCatName, string ComicName, string kidComicName, string gender, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, "", fn, ln, fn1, ln1, add + ", City : " + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, "", deltype, sb, duree,CatName, ComicName,kidCatName,kidComicName, "", "", "");
        ...
        [HttpPost]
        public ActionResult VoucherPageForPertaBuller(string sb, string sp, string duree, string deltype, string delprice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string ofrFname, string ofrname, string ofremail, string ofrmsg, string ofrsurname, string chkBymail, string livadd)
        {
            try
            {
                int i = 0;
                ...
                dt.Rows.Add(totamt, chkBymail, fn, ln, fn1, ln1, add + " City " + Ville + " Postal code : " + postcode, add1 + "City : " + Ville1 + "Postal Code : " + postcode1, Telephone, Telephone1, tmp, ofremail, deltype, sb, duree, "", "", "", "", ofrname, ofrFname, ofrmsg);
                ...
                ////Adding columns to datatable
                //dt.Columns.AddRange(new DataColumn[] { TotalAmt, ChkByMail, FirstName, Address, Contact, VoucharCode, EmailId, DelevaryType });
        ...
        public ActionResult VoucherPageForBSM(string sb, string sp, string duree, string deltype, string delprice, string CatName, string ComicName, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string ofrFname, string ofrname, string ofremail, string ofrmsg, string ofrsurname, string chkBymail, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, chkBymail, fn, ln, fn1, ln1, add + ", City :" + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, ofremail, deltype, sb, duree, CatName, ComicName, "", "", ofrname, ofrFname, ofrmsg);
        ...
        public ActionResult VoucherPageForMB(string sb, string sp, string duree, string deltype, string delprice, string kidCatName, string kidComicName, string gender, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string ofrFname, string ofrname, string ofremail, string ofrmsg, string ofrsurname, string chkBymail, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, chkBymail, fn, ln, fn1, ln1, add + ", City :" + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, ofremail, deltype, sb, duree, "", "", kidCatName, kidComicName, ofrname, ofrFname, ofrmsg);
        ...
        public ActionResult VoucherPageForMMB(string sb, string sp, string duree, string deltype, string delprice, string CatName, string kidCatName, string ComicName, string kidComicName, string gender, string ComicSelectionPrice, string totamt, string fn, string ln, string sec, string add, string comfac, string postcode, string Ville, string Telephone, string fn1, string ln1, string sec1, string add1, string comfac1, string postcode1, string Ville1, string Telephone1, string ofrFname, string ofrname, string ofremail, string ofrmsg, string ofrsurname, string chkBymail, string livadd)
        {
            try
            {
                ...
                dt.Rows.Add(totamt, chkBymail, fn, ln, fn1, ln1, add + ", City :" + Ville + ", Postal code : " + postcode, add1 + ", City : " + Ville1 + ", Postal Code : " + postcode1, Telephone, Telephone1, tmp, ofremail, deltype, sb, duree, CatName, ComicName, kidCatName, kidComicName, ofrname, ofrFname, ofrmsg);
                HttpContext.Session["data"] = dt;
                if (duree == "Prelevement Mensuel")
                {
                    cmd = new SqlCommand("spOrderManagement", con);
        ...
        public ActionResult Reg_Page()
        {
            ...
            HttpContext.Session["ID"] = strId;
            //return RedirectToAction("Reg_Page", new { id = strId });
            return View();
        }
        [HttpPost]
        public ActionResult Reg_Page(Commic.Models.Commic obj, string btnsave)
        {
            try
            {
                string str = HttpContext.Session["ID"].ToString();
                //string str = Request.Url.AbsolutePath+Qid;
                //string str = Request.QueryString["id"] != null ? Request.QueryString["id"].ToString() : "0";
                ...
                if (result > 0)
                {
                    ...
                    ViewBag.Message = "Et toc, t’es inscrit";
                    string line;
                    string pathToFiles = Server.MapPath("/Html_Files/SubscriptionConfirmationMail.html");
                    using (StreamReader sr = new StreamReader(pathToFiles))
                    {
                        line = sr.ReadToEnd();
                    }
                    line = line.Replace("Robert", obj.objRegistrationMaster.FirstName);
                    line = line.Replace("Walter", obj.objRegistrationMaster.LastName);
                    line = line.Replace("_n_", obj.objRegistrationMaster.EmailID);
                    line = line.Replace("_p_", obj.objRegistrationMaster.Password);
                    CommanMail(obj.objRegistrationMaster.EmailID, "", line, "Welcome Mail");
        ...
        public ActionResult LoginPage()
        {
            try
            {
                ViewBag.Qid = Request.QueryString["id"].ToString();
                if (Request.QueryString["isActive"] == "1")
                {
                    return View("Vouchar_Activation");
                }
                if (Request.Cookies["UserID"].Value != "")
                {
                    ...
                    string str = Request["id"] != null ? Request["id"].ToString() : "0";
                    //Response.Cookies["FirstName"].Value = obj.objLoginMaster.UserID.Trim();
                ...
                //else if (Request.Cookies["UserID"].Value == "")
                //{
                //    Commic.Models.Commic obj1 = new Models.Commic();
                //    obj1.objLoginMaster = new Models.Login();
                //    return View();
        ...
        public ActionResult ForgotPassword(Commic.Models.Commic obj)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MailAddress receiver = new MailAddress(obj.objforgotpwd.UserID);
                    ...
                    message.Body = "Dear " + dt.Rows[0]["FirstName"].ToString() + " Your password is:- " + dt.Rows[0]["Password"].ToString(); 
        ...
        public ActionResult Vouchar_Activation(Commic.Models.Commic obj)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0) 
                {
                    if (dt.Rows[0]["OfferCodeStatus"].ToString() == "Pending")
                    {
                        cmd = new SqlCommand("spActiveVouchar", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@VoucharCode", obj.objActiveVouchar.VoucharCode);
                        cmd.Parameters.AddWithValue("@Qtype", "VoucherStatusUpdate");
                        int res = cmd.ExecuteNonQuery();
                        if (res > 0)
                        {
                            ViewBag.Message = "Profitez de vos bandes dessinées";
                            string line1;
                            string pathToFiles1 = Server.MapPath("/Html_Files/VoucherCodeActivation.html");
                            using (StreamReader sr = new StreamReader(pathToFiles1))
                            {
                                line1 = sr.ReadToEnd();
                            }
                            line1 = line1.Replace("John", dt.Rows[0]["OfferFirstName"].ToString() != "" ? dt.Rows[0]["OfferFirstName"].ToString() : " NA ");
                            line1 = line1.Replace("XXX", dt.Rows[0]["ID"].ToString() != "" ? dt.Rows[0]["ID"].ToString() : " NA ");
                            line1 = line1.Replace("KPRLKNCLR", dt.Rows[0]["ID"].ToString() != "" ? dt.Rows[0]["ID"].ToString() : " NA ");
                            line1 = line1.Replace("_f_", dt.Rows[0]["SubscriptionName"].ToString() != "" ? dt.Rows[0]["SubscriptionName"].ToString() : " NA ");
                            line1 = line1.Replace("_du_", dt.Rows[0]["DurationType"].ToString() != "" ? dt.Rows[0]["DurationType"].ToString() : " NA ");
                            line1 = line1.Replace("_l_", dt.Rows[0]["DelevaryType"].ToString() != "" ? dt.Rows[0]["DelevaryType"].ToString() : " NA ");
                            
                           
                            CommanMail(dt.Rows[0]["OfferEmail"].ToString(), "", line1, "Voucher Activation Confirmed");
                        }
                        else
                        {
                            ViewBag.Message = "AIE ON NE VOUS A PAS RECONNU";
                            CommanMail(dt.Rows[0]["OfferEmail"].ToString(), "", "Hi User Ur Voucher Is Not Successfully Activated<br/> Plz Try After Some Time", "Voucher Activated");
                        }
                    }
                    else
                    {
                        ViewBag.Message = "Your Voucher is Already Activated...!";
                    }
                }
                else
                {
        ...
        public ActionResult CallPaymentGatweyApi(Commic.Models.Commic obj)
        {
            try
            {
                ...
                if (HttpContext.Session.Count > 0)
                {
                    ...
                    dtt = HttpContext.Session["data"] as DataTable;
                    if (dtt.Rows.Count > 0)
                    {
                        if (HttpContext.Session["SubsType"].ToString() == "Offer")
                        {
                            ...
                            else if ((res == "05" || res == "00" || res == "90") && dtt.Rows[0]["DelevaryType"].ToString() == "Livraison suivie")
                            {
                                if (dtt.Rows[0]["ChkByMail"].ToString() == "Courier")
                                {
                                    sandcode("frdvallee@gmail.com", (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) != "" ? (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) : "NA", (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) != "" ? (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) : "NA", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ", dtt.Rows[0]["VoucharCode"].ToString());
                                    //sandcodeToOwner("no-reply@chacunsabulle.com", dtt.Rows[0]["VoucharCode"].ToString(), dtt.Rows[0]["FirstName"].ToString(), dtt.Rows[0]["Address"].ToString(), dtt.Rows[0]["Contact"].ToString());
                                    string line;
                                    string pathToFiles = Server.MapPath("/Html_Files/OfferPaymentAcceptedMail.html");
                                    using (StreamReader sr = new StreamReader(pathToFiles))
                                    {
                                        line = sr.ReadToEnd();
                                    }
                                    line = line.Replace("Robert", dtt.Rows[0]["bFirstName"].ToString() != "" ? dtt.Rows[0]["bFirstName"].ToString() : " NA ");
                                    line = line.Replace("Walter", dtt.Rows[0]["bLastname"].ToString() != "" ? dtt.Rows[0]["bLastname"].ToString() : " NA ");
                                    line = line.Replace("John", dtt.Rows[0]["Offerprename"].ToString() != "" ? dtt.Rows[0]["Offerprename"].ToString() : " NA ");
                                    line = line.Replace("XXX", HttpContext.Session["currentid"].ToString() != "" ? HttpContext.Session["currentid"].ToString() : " NA ");
                                    CommanMail(HttpContext.Session["UserID"].ToString(), "", line, "Payment Successfull");
                                    string line1;
                                    string pathToFiles1 = Server.MapPath("/Html_Files/OfferFinalMail.html");
                                    using (StreamReader sr = new StreamReader(pathToFiles1))
                                    {
                                        line1 = sr.ReadToEnd();
                                    }
                                    line1 = line1.Replace("_f_", dtt.Rows[0]["SubsType"].ToString() != "" ? dtt.Rows[0]["SubsType"].ToString() : " NA ");
                                    line1 = line1.Replace("_du_", dtt.Rows[0]["Dureetype"].ToString() != "" ? dtt.Rows[0]["Dureetype"].ToString() : " NA ");
                                    //line1 = line1.Replace("_au_", dtt.Rows[0]["AdultUni"].ToString() != "" ? dtt.Rows[0]["AdultUni"].ToString() : " NA ");
                                    //line1 = line1.Replace("_eu_", dtt.Rows[0]["ChildUni"].ToString() != "" ? dtt.Rows[0]["ChildUni"].ToString() : " NA ");
                                    //line1 = line1.Replace("_ag_", dtt.Rows[0]["AdultGen"].ToString() != "" ? dtt.Rows[0]["AdultGen"].ToString() : " NA ");
                                    //line1 = line1.Replace("_eg_", dtt.Rows[0]["ChildGen"].ToString() != "" ? dtt.Rows[0]["ChildGen"].ToString() : " NA ");
                                    line1 = line1.Replace("Robert", dtt.Rows[0]["bFirstName"].ToString() != "" ? dtt.Rows[0]["bFirstName"].ToString() : " NA ");
                                    line1 = line1.Replace("Walter", dtt.Rows[0]["bLastname"].ToString() != "" ? dtt.Rows[0]["bLastname"].ToString() : " NA ");
                                    line1 = line1.Replace("John", dtt.Rows[0]["Offerprename"].ToString() != "" ? dtt.Rows[0]["Offerprename"].ToString() : " NA ");
                                    line1 = line1.Replace("shina", dtt.Rows[0]["Offername"].ToString() != "" ? dtt.Rows[0]["Offername"].ToString() : " NA ");
                                    line1 = line1.Replace("_n_", dtt.Rows[0]["FirstName"].ToString() != "" ? dtt.Rows[0]["FirstName"].ToString() : " NA ");
                                    line1 = line1.Replace("_p_", dtt.Rows[0]["Lastname"].ToString() != "" ? dtt.Rows[0]["Lastname"].ToString() : " NA ");
                                    line1 = line1.Replace("XXX", HttpContext.Session["currentid"].ToString() != "" ? HttpContext.Session["currentid"].ToString() : " NA ");
                                    line1 = line1.Replace("KPRLKNCLR", HttpContext.Session["currentid"].ToString() != "" ? HttpContext.Session["currentid"].ToString() : " NA ");
                                    line1 = line1.Replace("_l_", dtt.Rows[0]["DelevaryType"].ToString() != "" ? dtt.Rows[0]["DelevaryType"].ToString() : " NA ");
                                    line1 = line1.Replace("_add_", dtt.Rows[0]["Address"].ToString() != "" ? dtt.Rows[0]["Address"].ToString() : " NA ");
                                    line1 = line1.Replace("_con_", dtt.Rows[0]["Contact"].ToString() != "" ? dtt.Rows[0]["Contact"].ToString() : " NA ");

                                    line1 = line1.Replace("_bn_", dtt.Rows[0]["BFirstName"].ToString() != "" ? dtt.Rows[0]["BFirstName"].ToString() : " NA ");
                                    line1 = line1.Replace("_bp_", dtt.Rows[0]["BLastname"].ToString() != "" ? dtt.Rows[0]["BLastname"].ToString() : " NA ");
                                    line1 = line1.Replace("_bcon_", dtt.Rows[0]["BContact"].ToString() != "" ? dtt.Rows[0]["BContact"].ToString() : " NA ");
                                    line1 = line1.Replace("_badd_", dtt.Rows[0]["BAddress"].ToString() != "" ? dtt.Rows[0]["BAddress"].ToString() : " NA ");

                                    line1 = line1.Replace("_on_", dtt.Rows[0]["Offername"].ToString() != "" ? dtt.Rows[0]["Offername"].ToString() : " NA ");
                                    line1 = line1.Replace("_op_", dtt.Rows[0]["Offerprename"].ToString() != "" ? dtt.Rows[0]["Offerprename"].ToString() : " NA ");
                                    line1 = line1.Replace("_omsg_", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ");
                                    line1 = line1.Replace("_oemail_", dtt.Rows[0]["EmailId"].ToString() != "" ? dtt.Rows[0]["EmailId"].ToString() : " NA ");
                                    CommanMail(HttpContext.Session["UserID"].ToString(), "", line1, "Confirmed Subscription");
                                }
                                if (dtt.Rows[0]["ChkByMail"].ToString() == "mail")
                                {
                                    sandcode(dtt.Rows[0]["EmailId"].ToString(), (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) != "" ? (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) : "NA", (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) != "" ? (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) : "NA", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ", dtt.Rows[0]["VoucharCode"].ToString());
                                    string line;
                                    string pathToFiles = Server.MapPath("/Html_Files/OfferPaymentAcceptedMail.html");
                                    using (StreamReader sr = new StreamReader(pathToFiles))
                                    {
                                ...
                                FinalPaymentUpdate(Convert.ToInt32(HttpContext.Session["ordernumber"].ToString()));
                                ViewBag.Message = HttpContext.Session["ordernumber"].ToString();
                                return View("Confirmation_domicile_page_33");
                            }
                            else if ((res == "05" || res == "00" || res == "90") && dtt.Rows[0]["DelevaryType"].ToString() == "Retrait en Point Relay")
                            {
                                if (dtt.Rows[0]["ChkByMail"].ToString() == "Courier")
                                {
                                    sandcode("frdvallee@gmail.com", (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) != "" ? (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) : "NA", (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) != "" ? (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) : "NA", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ", dtt.Rows[0]["VoucharCode"].ToString());
                            ...
                            else if ((res == "05" || res == "00" || res == "90") && dtt.Rows[0]["DelevaryType"].ToString() == "Retrait aupres de nos pertenaires Gratuit, Paris 17/18/7 et Chichy")
                            {
                                if (dtt.Rows[0]["ChkByMail"].ToString() == "Courier")
                                {
                                    sandcode("frdvallee@gmail.com", (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) != "" ? (dtt.Rows[0]["bFirstName"].ToString() + " " + dtt.Rows[0]["bLastname"].ToString()) : "NA", (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) != "" ? (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) : "NA", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ", dtt.Rows[0]["VoucharCode"].ToString());
                                ...
                                if (dtt.Rows[0]["ChkByMail"].ToString() == "mail")
                                {
                                    sandcode(dtt.Rows[0]["EmailId"].ToString(), (dtt.Rows[0]["FirstName"].ToString() + " " + dtt.Rows[0]["Lastname"].ToString()) != "" ? (dtt.Rows[0]["FirstName"].ToString() + " " + dtt.Rows[0]["Lastname"].ToString()) : "NA", (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) != "" ? (dtt.Rows[0]["Offerprename"].ToString() + " " + dtt.Rows[0]["Offername"].ToString()) : "NA", dtt.Rows[0]["Offermsg"].ToString() != "" ? dtt.Rows[0]["Offermsg"].ToString() : " NA ", dtt.Rows[0]["VoucharCode"].ToString());
                                    string line;
                                    string pathToFiles = Server.MapPath("/Html_Files/OfferPaymentAcceptedMail.html");
                                    using (StreamReader sr = new StreamReader(pathToFiles))
                                    {
                                ...
                                //Commic.Models.Commic objcom = new Models.Commic();
                                FinalPaymentUpdate(Convert.ToInt32(HttpContext.Session["ordernumber"].ToString()));
                                ViewBag.Message1 = HttpContext.Session["livAdd"].ToString();
                                ViewBag.Message = HttpContext.Session["ordernumber"].ToString();
                        ...
                        else if (HttpContext.Session["SubsType"].ToString() == "sabnner")
                        {
                            ...
                            else if ((res == "05" || res == "00" || res == "90") && dtt.Rows[0]["DelevaryType"].ToString() == "Livraison suivie")
                            {
                                //Commic.Models.Commic objcom = new Models.Commic();
                                string line;
                                string pathToFiles = Server.MapPath("/Html_Files/PaymentAcceptedMail.html");
                                using (StreamReader sr = new StreamReader(pathToFiles))
                                {
                                    line = sr.ReadToEnd();
                                }
                                ...
                                CommanMail(HttpContext.Session["UserID"].ToString(), "", line, "Payment Successfull");
                                string line1;
                                string pathToFiles1 = Server.MapPath("/Html_Files/FinalMail.html");
                                using (StreamReader sr = new StreamReader(pathToFiles1))
                                {
                                    line1 = sr.ReadToEnd();
                                }
        ...
        public void RequestMethod(string orderno, string totamt)
        {
            try
            {
                ...
                */
                ...
                //call.setValue("normal_return_url", "http://test.chacunsabulle.com/index/CallPaymentGatweyApi?RequestType=Response");
                //call.setValue("cancel_return_url", "http://test.chacunsabulle.com/index/CallPaymentGatweyApi?RequestType=Response");
                //call.setValue("automatic_response_url", "http://test.chacunsabulle.com/index/CallPaymentGatweyApi?RequestType=AutoResponse");
        ...
        public void ResponseMethod()
        {
            ...
            try
            {
               ...
               // responseWriter.WriteLine("response_code = " + resp.getValue("response_code") + "<br />");
                ...
                HttpContext.Session["ordernumber"] = resp.getValue("order_id");
        ...
        public void FinalPaymentUpdate(int orderno)
        {
            try
            {
                cmd = new SqlCommand("spOrderManagement", con);
        ...
        public void sandcode(string id,string fromName,string ToName,string Msg, string Vouchercode)
        {
            ...
            try
            {
                ...
                string line;
                string pathToFiles = Server.MapPath("/Html_Files/SandVoucherCode.html");
                using (StreamReader sr = new StreamReader(pathToFiles))
                {
                ...
                //string strHyperlink = "<a href='http://test.chacunsabulle.com//Index/LoginPage?IsActive=1'>Pour activer cette Vouchar</a>";
                string strHyperlink = "<a href='http://www.chacunsabulle.com//Index/LoginPage?IsActive=1'>Pour activer cette Vouchar</a>";
                //string strHyperlink = "<a href='http://localhost:33285///Index/LoginPage?IsActive=1'>Pour activer cette Vouchar</a>";
                line = line.Replace("RobertWalters", fromName);
                line = line.Replace("msg", Msg);
                line = line.Replace("_on_", ToName);
                line = line.Replace("_link_", strHyperlink);
                line = line.Replace("XXXXX", Vouchercode);
        ...
        public string Stringres(string id, string Vouchercode, string bodymsg, string Subject)
        {
            string strMsg = "";
            try
            {
        ...
        public void CommanMail(string id, string Vouchercode, string bodymsg, string Subject)
        {
        ...
        [HttpPost]
        public ActionResult Error(Commic.Models.Commic obj)
        {
            try
            {
                cmd = new SqlCommand("spOrderManagement", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@OrderNo", Convert.ToInt32(HttpContext.Session["currentid"].ToString()));
                cmd.Parameters.AddWithValue("@Qtype", "GenrateTransectionNO");

                con.Open();
                TrasactionNumber = cmd.ExecuteScalar().ToString();
                HttpContext.Session["TrasactionNumber"] = TrasactionNumber;
                con.Close();
